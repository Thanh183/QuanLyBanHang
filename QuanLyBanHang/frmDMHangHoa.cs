...
namespace QuanLyBanHang
{
    public partial class frmDMHangHoa : Form
    {
        ...
        private void frmDMHangHoa_Load(object sender, EventArgs e)
        {
            ...
            LoadDataGridView();
            Functions.FillComboCL(sql, cboMaChatLieu, "Mã chất liệu", "Tên chất liệu");
        ...
        private void LoadDataGridView()
        {
            ...
            tblH = Functions.GetDataToTableH(sql);
            dgvHang.DataSource = tblH;
            dgvHang.Columns[0].HeaderText = "Mã hàng";
            dgvHang.Columns[1].HeaderText = "Tên hàng";
            dgvHang.Columns[2].HeaderText = "Mã chất liẹu";          
        ...
        private void dgvHang_Click(object sender, EventArgs e)
        {
            ...
            txtMaHang.Text = dgvHang.CurrentRow.Cells["Mã hàng"].Value.ToString();
            txtTenHang.Text = dgvHang.CurrentRow.Cells["Tên hàng"].Value.ToString();
            MaChatLieu = dgvHang.CurrentRow.Cells["Mã chất liệu"].Value.ToString();
            sql = "SELECT TenChatLieu FROM tblchatlieu WHERE MaChatLieu=N'" + MaChatLieu + "'";
            cboMaChatLieu.Text = Functions.GetFieldValues(sql);
            txtSoLuong.Text = dgvHang.CurrentRow.Cells["Số lượng"].Value.ToString();
            txtDonGiaNhap.Text = dgvHang.CurrentRow.Cells["Đơn giá nhập"].Value.ToString();
            txtDonGiaBan.Text = dgvHang.CurrentRow.Cells["Đơn giá bán"].Value.ToString();
