...
namespace QuanLyBanHang
{
    public partial class frmDMKhachHang : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            tblKH = Functions.GetDataToTableKH(sql); //Lấy dữ liệu từ bảng
        ...
        private void dgvKhachHang_Click(object sender, EventArgs e)
        {
            ...
            txtMaKhach.Text = dgvKhachHang.CurrentRow.Cells["Mã khách"].Value.ToString();
            txtTenKhach.Text = dgvKhachHang.CurrentRow.Cells["Tên khách"].Value.ToString();
            txtDiaChi.Text = dgvKhachHang.CurrentRow.Cells["Địa chỉ"].Value.ToString();
            mtbDienThoai.Text = dgvKhachHang.CurrentRow.Cells["Điện thoại"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
