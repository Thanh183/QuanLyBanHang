...
namespace QuanLyBanHang
{
    public partial class frmDMChatLieu : Form
    {
        ...
        private void LoadDataGridView()
        {
            ...
            tblCL = Class.Functions.GetDataToTableCL(sql); //Đọc dữ liệu từ bảng
        ...
        private void dgvChatLieu_Click(object sender, EventArgs e)
        {
            ...
            txtMaChatLieu.Text = dgvChatLieu.CurrentRow.Cells["Mã chất liệu"].Value.ToString();
            txtTenChatLieu.Text = dgvChatLieu.CurrentRow.Cells["Tên chất liệu"].Value.ToString();
            btnSua.Enabled = true;
            btnXoa.Enabled = true;
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (Class.Functions.CheckKeyCL(sql))
            {
        ...
        private void btnXoa_Click(object sender, EventArgs e)
        {
            ...
            {
                sql = "DELETE FROM tblchatlieu WHERE MaChatLieu=N'" + txtMaChatLieu.Text + "'";
                Class.Functions.RunSQL(sql);
                LoadDataGridView();
                ResetValue();
            }
