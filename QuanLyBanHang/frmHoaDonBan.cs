...
namespace QuanLyBanHang
{
    public partial class frmHoaDonBan : Form
    {
        ...
        private void frmHoaDonBan_Load(object sender, EventArgs e)
        {
            ...
            txtGiamGia.Text = "0";
            labelTT.Text = "0";
            Functions.FillComboKhach("SELECT MaKhach, TenKhach FROM tblkhach", cboMaKhach, "Mã khách", "Mã khách");
            cboMaKhach.SelectedIndex = -1;
            Functions.FillComboNhanVien("SELECT MaNhanVien, TenNhanVien FROM tblnhanvien", cboMaNhanVien, "Mã nhân viên", "Mã nhân viên");
            cboMaNhanVien.SelectedIndex = -1;
            Functions.FillComboHang("SELECT MaHang, TenHang FROM tblhang", cboMaHang, "Mã hàng", "Mã hàng");
        ...
        {
            string sql;
            sql = "SELECT a.MaHang, b.TenHang, a.SoLuong, b.DonGiaBan, a.GiamGia,a.ThanhTien FROM tblchitiethdban AS a INNER JOIN tblhang AS b ON a.MaHang=b.MaHang;";
            tblCTHDB = Functions.GetDataToTableCTHD(sql);
        ...
        private void LoadInfoHoaDon()
        {
            ...
            //dtpNgayBan.Text = Functions.ConvertReverse(Functions.GetFieldValues(str));            
        ...
        private void btnLuu_Click(object sender, EventArgs e)
        {
            ...
            if (!Functions.CheckKeyHDB(sql))
            {
                // Mã hóa đơn chưa có, tiến hành lưu các thông tin chung
                // Mã HDBan được sinh tự động do đó không có trường đó khônghợp trùng khóa
                ...
                sql = "INSERT INTO tblHDBan(MaHDBan, NgayBan, MaNhanVien, MaKhach, TongTien) VALUES (N'" + txtMaHDBan.Text.Trim() + "','" +
                        Functions.ConvertDateTime(dtpNgayBan.Text) + "',N'" + cboMaNhanVien.SelectedValue + "',N'" +
        ...
        {
            Functions.FillComboHDB("SELECT MaHDBan FROM tblhdban", cboMaHD, "Mã HD Bán", "Mã HD Bán");
        ...
        private void btnInHoaDon_Click(object sender, EventArgs e)
        {
            ...
            exRange.Range["A1:B1"].Value = "Shop XXXXXX";
            exRange.Range["A2:B2"].MergeCells = true;
            exRange.Range["A2:B2"].HorizontalAlignment = COMExcel.XlHAlign.xlHAlignCenter;
            exRange.Range["A2:B2"].Value = "Vị trí XXXXXXX";
            ...
            sql = "SELECT a.MaHDBan, a.NgayBan, a.TongTien, b.TenKhach, b.DiaChi, b.DienThoai, c.TenNhanVien FROM (tblHDBan AS a INNER JOIN tblKhach AS b ON a.MaKhach = b.MaKhach) INNER JOIN tblNhanVien AS c ON a.MaNhanVien = c.MaNhanVien WHERE a.MaHDBan = N'" + txtMaHDBan.Text + "'";
            tblThongtinHD = Functions.GetDataToTableTTHD(sql);
            ...
            tblThongtinHang = Functions.GetDataToTableTTMH(sql);
